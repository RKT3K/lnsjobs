...
<section class="account-section login-section">
    <div class="account-area">
        <div class="account-area__inner">
            ...
            <h6 class="title text-white text-center">{{auth()->user()->email}}</h6>
            <form method="POST" action="{{route('user.verify.email')}}" class="account-form box--border box--shadow p-sm-5 p-3 rounded-3">
                @csrf
