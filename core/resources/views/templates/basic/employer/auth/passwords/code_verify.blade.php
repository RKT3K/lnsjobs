...
<section class="account-section login-section">
    <div class="account-area">
        <div class="account-area__inner">
            <form method="POST" action="{{ route('employer.password.verify.code') }}" class="account-form box--border box--shadow p-sm-5 p-3 rounded-3">
                @csrf
                ...
                <p class="mt-3 text-center text-white">
                    ...
                    <a href="{{ route('employer.password.request') }}">@lang('Try to send again')</a>
                </p>
            </form>
        </div>
    </div>
