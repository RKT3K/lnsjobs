                        ...
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                <td data-label="@lang('User')">
                                    ...
                                    <br>
                                    <span class="small">
                                    <a href="{{ route('admin.employers.detail', $user->id) }}"><span>@</span>{{ $user->username }}</a>
                                    </span>
                                </td>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('admin.employers.detail', $user->id) }}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="@lang('Details')">
...
@push('breadcrumb-plugins')
    <form action="{{ route('admin.employers.search', $scope ?? str_replace('admin.employers.', '', request()->route()->getName())) }}" method="GET" class="form-inline float-sm-right bg--white">
