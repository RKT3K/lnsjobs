    ...
    <div class="row mt-50 mb-none-30">
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--12 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$other['order']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Plan Subscriber')</span>
                    </div>

                    <a href="{{route('admin.plan.subscriber')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$other['plan']}}</span>
                    </div>
                    <div class="desciption">
